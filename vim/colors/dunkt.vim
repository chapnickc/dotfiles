...
if &t_Co > 255
   ...
   hi Directory       ctermfg=47               cterm=bold
   hi Error           ctermfg=219 ctermbg=89
   hi ErrorMsg        ctermfg=199 ctermbg=16    cterm=bold
   hi Exception       ctermfg=47               cterm=bold
   ...
   hi PreCondit       ctermfg=47               cterm=bold
   ...
   " marks column
   hi SignColumn      ctermfg=47 ctermbg=235
